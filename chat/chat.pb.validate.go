...
// Validate checks the field values on SCSystemMessage with the rules defined
// in the proto definition for this message. If any rules are violated, an
// error is returned.
...
// SCSystemMessageValidationError is the validation error returned by
// SCSystemMessage.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e SCSystemMessageValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SCSystemMessageValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SCSystemMessageValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SCSystemMessageValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SCSystemMessageValidationError) ErrorName() string { return "SCSystemMessageValidationError" }

// Error satisfies the builtin error interface
func (e SCSystemMessageValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSCSystemMessage.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SCSystemMessageValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SCSystemMessageValidationError{}
