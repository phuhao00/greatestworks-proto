...
// Validate checks the field values on PlayerData with the rules defined in the
// proto definition for this message. If any rules are violated, an error is returned.
...
// PlayerDataValidationError is the validation error returned by
// PlayerData.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e PlayerDataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PlayerDataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PlayerDataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PlayerDataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PlayerDataValidationError) ErrorName() string { return "PlayerDataValidationError" }
...
var _ error = PlayerDataValidationError{}
